...
<div id="help-accordion-<?=$num?>-content" class="collapse" aria-labelledby="help-accordion-<?=$num?>-head" data-parent="#help-accordion">
    <div class="card-body">
        <h5 class="card-title text-danger">メッセージボックスをクリック</h5>
        <p class="card-text">
            メッセージボックスのクリックまたはタップが、ゲーム機本体のAボタン（決定ボタン）と同じ役割を担っています。メッセージボックス右下に（CLICK）という文字が点滅していると、クリックすることでゲームが進行します。<br>
            表示されていない間は、操作ボタンを押してください。実装されていない機能はボタンを押してもアクションが起こりません。
        </p>
    </div>
</div>
